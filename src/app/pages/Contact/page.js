...
export default function ContactPage() {
  ...
  return (
    <section id="contact" className="min-h-screen py-5 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 justify-items-center">
          ...
          <div className="w-[350px] h-[350px] p-6 rounded-2xl border border-white/20 bg-white/10 backdrop-blur-xl shadow-sm flex flex-col mt-4 items-center">
            <h2 className="text-sm mb-6 font-regular">Contact Information</h2>

            <div className="space-y-5 text-slate-700">
              <InfoRow icon={<Phone size={20} />} text="+91 7845205463" />
              <InfoRow icon={<Mail size={20} />} text="thirumalai.ink@gmail.com" />
              <InfoRow icon={<MapPin size={20} />} text="Bikkampatti, Dharmapuri" />
            </div>
          </div>
          ...
          <div className="w-[350px] h-[350px] p-6 rounded-2xl border border-white/20 bg-white/10 backdrop-blur-xl overflow-hidden shadow-sm">
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-3">
              ...
              <button
                ...
                className="w-24 bg-blue-600 hover:bg-blue-700 text-white text-sm py-2 rounded-md flex items-center justify-center gap-2 disabled:opacity-60 focus:outline-none focus:ring-0"
              >
